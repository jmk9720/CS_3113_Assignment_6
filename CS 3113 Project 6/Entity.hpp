...
public:
    ...
    void const check_collision_bullet(Entity* collidable_entities, int collidable_entity_count);
    ...
    void bullet_activate();
    void bullet_deactivate();
