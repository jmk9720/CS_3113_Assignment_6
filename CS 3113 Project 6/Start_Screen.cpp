...
void Start_Screen::render(ShaderProgram *program)
{
    ...
    Utility::draw_text(program, text_texture_id, "Press ENTER to Play", 0.5f, 0.0f, glm::vec3(0.5f, -4.0f, 0.0f));
    Utility::draw_text(program, text_texture_id, "RUN AWAY", 0.5f, 0.0f, glm::vec3(3.0f, -2.0f, 0.0f));
